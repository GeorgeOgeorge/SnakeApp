...
class Snake : Serializable {
    var body: ArrayList<Array<Int>> = arrayListOf(arrayOf(0, 0))
    ...
    fun changeDirection(direction: Int) {
        when (direction) {
            1 -> if (this.direction != 4) this.direction = 1
            2 -> if (this.direction != 3) this.direction = 2
            3 -> if (this.direction != 2) this.direction = 3
            4 -> if (this.direction != 1) this.direction = 4
        }
    }
